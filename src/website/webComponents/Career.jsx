  ...
  return (
    <section className="w-full px-4 sm:px-6 py-14 sm:py-20 bg-white">
      <div className="max-w-4xl mx-auto text-center">
        ...
        {/* Heading */}
        <h2 className="text-2xl sm:text-2xl md:text-3xl font-bold text-gray-800 leading-snug mb-4">
        ...
        <Link
          ...
          className="inline-block mt-6 sm:mt-8 px-5 sm:px-7 py-2.5 sm:py-3 
                     ...
                     hover:bg-blue-800 transition-all duration-200 text-sm sm:text-sm"
        >
          Explore Careers
        </Link>
