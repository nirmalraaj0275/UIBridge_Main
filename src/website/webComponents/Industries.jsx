        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mt-2 text-sm">
                Industry 4.0 solutions and smart factory enablement.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mt-2 text-sm">
                Product experiences that delight end users.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mt-2 text-sm">
                3D modelling-based interior & furniture solutions that elevate brand identity.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mt-2 text-sm">
                Sustainable engineering solutions for aviation and space exploration.
              </p>
            </div>
          </div>
          ...
          >
            ...
            />
            <div className="p-6">
              <h3 className="text-xl font-semibold text-gray-900">Semiconductor</h3>
              <p className="text-gray-600 mt-2 text-sm">
                Firmware, driver bring-up and validation at silicon scale.
              </p>
            </div>
          </div> */}
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mt-2 text-sm">
                Autonomy, connectivity and safety-first automotive architectures.
              </p>
            </div>
          </div>
